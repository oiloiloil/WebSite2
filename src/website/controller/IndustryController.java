...
public class IndustryController {
	...
	public void doQuery(HttpServletRequest req, HttpServletResponse res) throws Exception {
	...
	public void doEdit(HttpServletRequest req, HttpServletResponse res) throws Exception {
